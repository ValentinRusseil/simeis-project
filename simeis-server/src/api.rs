...
// TODO (#23) Use POST queries also, instead of everything with GET

// TODO (#24) Use query parameters (with ntex::web::types::Query) instead of plain URLs
...
// TODO (#23)   Ensure that multiple players cannot lock themselves:
//     Ask for write on X, wait for read on Y
//     Ask for write on Y, wait for read on X

// TODO  (#23)  Centralise every read / write in the API
...
// CHECKED
// TODO (#23) IMPORTANT    Get ship ID here, and adapt prices based on the ranks of the modules
...
// CHECKED
// TODO (#25)    Have an endpoint /station/{station_id}/crew/upgrade/{crew_id} instead
...
async fn get_prices_ship_module(
    ...
    // TODO (#24) Price based on station
