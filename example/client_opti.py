...
class Game:
    ...
    def go_mine(self):
        ...
        for resource, price in market["prices"].items():
            ...
            # print(f"crew: {self.get(f'/station/{self.sta}')['crew'].all()}")
            # if mostProfitableResource.minRank > self.get(f"/station/{self.sta}")["crew"]["Operator"]["rank"]:
            #     print(f"[*] You need a crew with rank {mostProfitableResource.minRank} to mine {mostProfitableResource.name}, aborting mining operation")
            #     return
